...
var format_2RSSSCIMMMyPlaces_5 = new ol.format.GeoJSON();
var features_2RSSSCIMMMyPlaces_5 = format_2RSSSCIMMMyPlaces_5.readFeatures(json_2RSSSCIMMMyPlaces_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_2RSSSCIMMMyPlaces_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_2RSSSCIMMMyPlaces_5.addFeatures(features_2RSSSCIMMMyPlaces_5);
var lyr_2RSSSCIMMMyPlaces_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_2RSSSCIMMMyPlaces_5, 
                style: style_2RSSSCIMMMyPlaces_5,
                popuplayertitle: "2RSSSCIMM — My Places",
                interactive: true,
                title: '2RSSSCIMM — My Places'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIADMINISTRASIDESA_AR_25K_1.setVisible(true);lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIADMINISTRASI_LN_25K_2.setVisible(true);lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIJALAN_LN_25K_3.setVisible(true);lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIKESEHATAN_PT_25K_4.setVisible(true);lyr_2RSSSCIMMMyPlaces_5.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIADMINISTRASIDESA_AR_25K_1,lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIADMINISTRASI_LN_25K_2,lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIJALAN_LN_25K_3,lyr_PETAPERSEBARANRUMAHSAKITDICIMAHIKESEHATAN_PT_25K_4,lyr_2RSSSCIMMMyPlaces_5];
...
lyr_2RSSSCIMMMyPlaces_5.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_2RSSSCIMMMyPlaces_5.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', });
...
lyr_2RSSSCIMMMyPlaces_5.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_2RSSSCIMMMyPlaces_5.on('precompose', function(evt) {
